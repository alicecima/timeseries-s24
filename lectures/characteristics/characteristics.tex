...
\begin{itemize}
\item Instructor: Alice Cima
\item GSI: 
\item Reader: 

\item On bCourses you will find lecture notes, homework assignments,
  syllabus.

\ We will use Ed for discussion and Gradescope for homework submissions.
...
\item Read the syllabus for the projected list of topics
  that we will cover.
